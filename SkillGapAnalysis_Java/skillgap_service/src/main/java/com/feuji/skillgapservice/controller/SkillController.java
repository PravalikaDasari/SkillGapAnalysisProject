...
public class SkillController {
    ...
    public ResponseEntity<String> updateSkillStatus(@RequestParam Integer skillId, @RequestParam Byte status) throws RecordNotFoundException {
        try {
            skillService.updateStatusBySkillId(skillId, status);
