...
public class SkillCompetencyController {
	...
	public ResponseEntity<SkillCompetencyBean> updateAllSkillCompetencyRecords(
		...
		try {
			skillCompetencyService
					.updateAllSkillCompetencyRecords(competencyBean);
	...
	public ResponseEntity<List<TrainigRecommendedEmployeesDto>> getAllTrainingRecommendedEmp(@PathVariable int[] skillIds)
	{
